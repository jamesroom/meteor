$(document).ready(function(){
    ...
    console.log($(".head").innerWidth())
    $("#canvas,#canvas1").attr("width",$(".head,.header").innerWidth());
    $("#canvas,#canvas1").attr("height",$(".head,.header").innerHeight());
    var MeteorCount = 10;
    ...
    function playMeteors() //流星
    {
        for (var i = 0; i < MeteorCount; i++) //循环处理
        {
            ...
            if (Meteors[i].y>$(".head,.header").innerHeight()||Meteors[i].alpha<=0.01) //到达下线
            {
